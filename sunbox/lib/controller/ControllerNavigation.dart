...
class Navegacao{
  ...
  static void mapa_menu(context)=> Navigator.push(context, MaterialPageRoute(builder: (context)=>Mapa(true)));
  ...
  static void mapa_save(context)=> Navigator.push(context, MaterialPageRoute(builder: (context)=>Mapa(true)));
